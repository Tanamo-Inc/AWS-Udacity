...
class Binomial(Distribution):
    ...
    Questions: Fill out all TODOs in the functions below
    ...
    def __init__(self, prob=.5, size=20):
       ...
       # Question: store the size of the distribution in an instance variable n
        self.n = size

       # Question: store the probability of the distribution in an instance variable p
        self.p = prob

        # Question: Now that you know p and n, you can calculate the mean and standard deviation
    ...
    def calculate_mean(self):
        ...
        # Question: calculate the mean of the Binomial distribution. Store the mean
    ...
    def calculate_stdev(self):
        ...
        # Question: calculate the standard deviation of the Binomial distribution. Store
    ...
    def replace_stats_with_data(self):
        ...
        # Question: The read_data_file() from the Generaldistribution class can read in a data
    ...
    def plot_bar(self):
        ...
        # Question: Use the matplotlib package to plot a bar chart of the data
    ...
    def pdf(self, k):
        ...
        # Question: Calculate the probability density function for a binomial distribution
    ...
    def plot_bar_pdf(self):
        ...
        # Question: Use a bar chart to plot the probability density function from
        # k = 0 to k = n
    ...
    def __add__(self, other):
        ...
        # Question: Define addition for two binomial distributions. Assume that the
    ...
    def __repr__(self):
        ...
        # Question: Define the representation method so that the output looks like
